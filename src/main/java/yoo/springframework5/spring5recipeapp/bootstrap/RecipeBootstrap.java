package yoo.springframework5.spring5recipeapp.bootstrap;

import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import yoo.springframework5.spring5recipeapp.domain.*;
import yoo.springframework5.spring5recipeapp.repositories.CategoryRepository;
import yoo.springframework5.spring5recipeapp.repositories.RecipeRepository;
import yoo.springframework5.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        quacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
